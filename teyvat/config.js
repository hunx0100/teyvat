...
// 내용 수정
var text = {
    load_start: "현재 육반교(교황청) 수도 : 티바트 (2024)", // 다운로드 시작
    load_end: "다운로드 완료.. 접속시도중..", // 다운로드 끝나고
    server_info_t: "나중에 이 사이트가 보이지 않는다는 것은 육반교(교황청)의 멸망을 알리는 것입니다.", // 서버 정보 - 머리말
    server_info_m: "", // 서버 정보 - 맵
    server_info_n: "", // 서버 정보 - 서버 이름
    server_info_g: "", // 서버 정보 - 게임 모드
    server_info_s: "" // 서버 정보 - 플레이어 고유번호
};
